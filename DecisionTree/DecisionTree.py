...
if __name__ == '__main__':
    ...
    metric_input = input('Which metric do you use? (entropy/majority_error/gini): ')
    ...
    if impute_input == 'Y':
        test_score = evaluate(train_file, test_file, id3, metric_input, depth_input, impute_missing = True)
    else:
